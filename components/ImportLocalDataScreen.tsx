      ...
      >
        <View style={{ gap: 18 }}>
          ...
          <View style={{ gap: 10 }}>
            ...
            >
              You already have local OnTrack data on this device. Before cloud
              sync turns on, choose whether to copy it into your account.
            </Text>
          </View>
          ...
          >
            ...
            <Text style={{ color: theme.textSecondary, lineHeight: 20 }}>
              {goalCount} goal{goalCount === 1 ? "" : "s"} and {taskCount} task
              {taskCount === 1 ? "" : "s"} are stored only on this device right
              now.
            </Text>
            <Text style={{ color: theme.textSecondary, lineHeight: 20 }}>
              Importing will upload this local copy to Supabase so it can sync
              across devices.
            </Text>
          </View>
